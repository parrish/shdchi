...
$(function() {
      ...
      url ="http://osm2.cartodb.com/api/v2/sql?q=SELECT ST_XMax(ST_Extent(the_geom)) as maxx,ST_YMax(ST_Extent(the_geom)) as maxy,ST_XMin(ST_Extent(the_geom)) as minx,ST_YMin(ST_Extent(the_geom)) as miny FROM openpaths_segments";
