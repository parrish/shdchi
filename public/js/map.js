$(function() {
			...
			var map = new L.Map('map_cartodb_container').setView(new L.LatLng(20,0), 2);
		...
		var style="#openpaths_segments{polygon-opacity:0.7;[prop_count>0]{polygon-fill:#415E9E;polygon-opacity:0.1}[prop_count>2]{polygon-fill:#6581B5;polygon-opacity:0.7}[prop_count>4]{polygon-fill:#88A3CC}[prop_count>6]{polygon-fill:#ACC6E3;}[prop_count>8]{polygon-fill:#88A3CC;}[prop_count>10]{polygon-fill:#F6BEB5;}[prop_count>30]{polygon-fill:#E3928C;}[prop_count>50]{polygon-fill:#CF6562;}[prop_count>100]{polygon-fill:#BC3939;}line-opacity:0.21;line-color:#000000;line-width:0.8;}";
